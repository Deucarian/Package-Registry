...
| API | com.deucarian.api | Compliant | Yes | Yes | 71 | 1 | 0 | 0 |
| Attacks | com.deucarian.attacks | RefactorBacklog | Yes | Yes | 64 | 1 | 2 | 0 |
...
| Build-Pipeline | com.deucarian.build-pipeline | RefactorBacklog | Yes | Yes | 38 | 1 | 1 | 0 |
...
| Command-Routing | com.deucarian.command-routing | Compliant | Yes | Yes | 35 | 1 | 0 | 0 |
...
| Editor | com.deucarian.editor | Compliant | Yes | Yes | 117 | 2 | 0 | 0 |
...
| Notifications | com.deucarian.notifications | SetupRequired | No | Yes | 35 | 2 | 0 | 0 |
...
| Run-Upgrades | com.deucarian.run-upgrades | RefactorBacklog | Yes | Yes | 20 | 1 | 2 | 0 |
...
| Theming | com.deucarian.theming | RefactorBacklog | Yes | Yes | 146 | 2 | 2 | 0 |
| UI | com.deucarian.ui | RefactorBacklog | Yes | Yes | 39 | 1 | 3 | 0 |
| UI-Binding | com.deucarian.ui-binding | Compliant | Yes | Yes | 12 | 1 | 0 | 0 |
| UI-FLow | com.deucarian.ui-flow | RefactorBacklog | Yes | Yes | 55 | 2 | 1 | 0 |
| UIBinding-CoreState-Integration | com.deucarian.ui-binding.core-state-integration | Compliant | Yes | Yes | 3 | 1 | 0 | 0 |
| Viewer-Authentication | com.deucarian.authentication | SetupRequired | No | Yes | 52 | 1 | 0 | 0 |
| Viewer-Navigation | com.deucarian.viewer-navigation | SetupRequired | No | Yes | 33 | 2 | 0 | 0 |
...
| Weapon-Systems | com.deucarian.weapon-systems | Compliant | Yes | Yes | 19 | 1 | 0 | 0 |
...
| Attacks | ProductionFileExceedsLineLimit | RefactorBacklog | Editor/AttackGameContentAuthoringProviders.cs | 1343 | 500 | Extract responsibilities until the production file is at most 500 lines. |
...
| Run-Upgrades | ProductionFileExceedsLineLimit | RefactorBacklog | Editor/RunUpgradeGameContentAuthoringProvider.cs | 576 | 500 | Extract responsibilities until the production file is at most 500 lines. |
