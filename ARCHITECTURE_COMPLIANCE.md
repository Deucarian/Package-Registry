...
- Repositories: 65
- Fully compliant repositories: 44
...
| API | com.deucarian.api | Compliant | Yes | Yes | 73 | 1 | 0 | 0 |
| Attacks | com.deucarian.attacks | RefactorBacklog | Yes | Yes | 69 | 1 | 2 | 0 |
...
| Camera-Navigation | com.deucarian.camera-navigation | RefactorBacklog | Yes | Yes | 28 | 1 | 1 | 0 |
...
| Editor | com.deucarian.editor | Compliant | Yes | Yes | 130 | 2 | 0 | 0 |
...
| Notifications | com.deucarian.notifications | SetupRequired | No | Yes | 37 | 2 | 0 | 0 |
...
| Package-Installer | com.deucarian.package-installer | RefactorBacklog | Yes | Yes | 203 | 1 | 11 | 0 |
...
| Run-Upgrades | com.deucarian.run-upgrades | RefactorBacklog | Yes | Yes | 23 | 1 | 2 | 0 |
...
| Template-Game-Movement-FPS | com.deucarian.template.game.movement-fps | Compliant | Yes | Yes | 63 | 2 | 0 | 0 |
| Template-Game-Survivors | com.deucarian.template.game.survivors | RefactorBacklog | Yes | Yes | 224 | 2 | 12 | 0 |
...
| Theming | com.deucarian.theming | RefactorBacklog | Yes | Yes | 151 | 2 | 2 | 0 |
| UI | com.deucarian.ui | RefactorBacklog | Yes | Yes | 39 | 1 | 3 | 0 |
| UI-Binding | com.deucarian.ui-binding | Compliant | Yes | Yes | 12 | 1 | 0 | 0 |
| UI-FLow | com.deucarian.ui-flow | RefactorBacklog | Yes | Yes | 56 | 2 | 1 | 0 |
| UIBinding-CoreState-Integration | com.deucarian.ui-binding.core-state-integration | Compliant | Yes | Yes | 3 | 1 | 0 | 0 |
| Viewer-Authentication | com.deucarian.authentication | SetupRequired | No | Yes | 55 | 1 | 0 | 0 |
| Viewer-Navigation | com.deucarian.viewer-navigation | SetupRequired | No | Yes | 34 | 2 | 0 | 0 |
...
| Weapon-Systems | com.deucarian.weapon-systems | Compliant | Yes | Yes | 21 | 1 | 0 | 0 |
...
| Attacks | ProductionFileExceedsLineLimit | RefactorBacklog | Editor/AttackGameContentAuthoringProviders.cs | 1355 | 500 | Extract responsibilities until the production file is at most 500 lines. |
...
| Game-Content-Authoring | ProductionFileExceedsLineLimit | RefactorBacklog | Editor/GameContentPackAwareViews.cs | 715 | 500 | Extract responsibilities until the production file is at most 500 lines. |
...
| Game-Content-Authoring | ProductionFileExceedsLineLimit | RefactorBacklog | Editor/GameContentPackBrowser.cs | 586 | 500 | Extract responsibilities until the production file is at most 500 lines. |
...
| Run-Upgrades | ProductionFileExceedsLineLimit | RefactorBacklog | Editor/RunUpgradeGameContentAuthoringProvider.cs | 580 | 500 | Extract responsibilities until the production file is at most 500 lines. |
