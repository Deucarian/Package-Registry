...
| Template-Game-Survivors | Editor/SurvivorsEditorContentValidation.cs | 27 | Editor production | Debug.LogError | Error | Allowed | Info | Template editor content validation intentionally prints validation summaries to the Unity console for developer visibility. |
| Template-Game-Survivors | Editor/SurvivorsEditorContentValidation.cs | 31 | Editor production | Debug.LogWarning | Warning | Allowed | Info | Template editor content validation intentionally prints validation summaries to the Unity console for developer visibility. |
| Template-Game-Survivors | Editor/SurvivorsEditorContentValidation.cs | 35 | Editor production | Debug.Log | Info | Allowed | Info | Template editor content validation intentionally prints validation summaries to the Unity console for developer visibility. |
