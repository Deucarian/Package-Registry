...
| Template-Game-Idle-Auto-Defense | Runtime/IdleAutoDefenseTemplate.cs | 5264 | Runtime production | Debug.LogError | Error | Allowed | Info | Template diagnostics are intentionally visible in the Unity console; replacing them with Logging should be handled with an explicit dependency/governance phase. |
| Template-Game-Idle-Auto-Defense | Runtime/IdleAutoDefenseTemplate.cs | 5317 | Runtime production | Debug.LogWarning | Warning | Allowed | Info | Template diagnostics are intentionally visible in the Unity console; replacing them with Logging should be handled with an explicit dependency/governance phase. |
| Template-Game-Idle-Auto-Defense | Runtime/IdleAutoDefenseTemplate.cs | 5329 | Runtime production | Debug.LogWarning | Warning | Allowed | Info | Template diagnostics are intentionally visible in the Unity console; replacing them with Logging should be handled with an explicit dependency/governance phase. |
| Template-Game-Idle-Auto-Defense | Runtime/IdleAutoDefenseTemplate.cs | 5355 | Runtime production | Debug.LogWarning | Warning | Allowed | Info | Template diagnostics are intentionally visible in the Unity console; replacing them with Logging should be handled with an explicit dependency/governance phase. |
| Template-Game-Idle-Auto-Defense | Runtime/IdleAutoDefenseTemplate.cs | 5365 | Runtime production | Debug.LogWarning | Warning | Allowed | Info | Template diagnostics are intentionally visible in the Unity console; replacing them with Logging should be handled with an explicit dependency/governance phase. |
| Template-Game-Idle-Auto-Defense | Runtime/IdleAutoDefenseTemplate.cs | 5517 | Runtime production | Debug.LogWarning | Warning | Allowed | Info | Template diagnostics are intentionally visible in the Unity console; replacing them with Logging should be handled with an explicit dependency/governance phase. |
| Template-Game-Idle-Auto-Defense | Runtime/IdleAutoDefenseTemplate.cs | 5531 | Runtime production | Debug.LogWarning | Warning | Allowed | Info | Template diagnostics are intentionally visible in the Unity console; replacing them with Logging should be handled with an explicit dependency/governance phase. |
| Template-Game-Idle-Auto-Defense | Runtime/IdleAutoDefenseTemplate.cs | 5545 | Runtime production | Debug.LogWarning | Warning | Allowed | Info | Template diagnostics are intentionally visible in the Unity console; replacing them with Logging should be handled with an explicit dependency/governance phase. |
| Template-Game-Idle-Auto-Defense | Runtime/IdleAutoDefenseTemplate.cs | 5559 | Runtime production | Debug.LogWarning | Warning | Allowed | Info | Template diagnostics are intentionally visible in the Unity console; replacing them with Logging should be handled with an explicit dependency/governance phase. |
| Template-Game-Idle-Auto-Defense | Runtime/IdleAutoDefenseTemplate.cs | 5573 | Runtime production | Debug.LogWarning | Warning | Allowed | Info | Template diagnostics are intentionally visible in the Unity console; replacing them with Logging should be handled with an explicit dependency/governance phase. |
