...
3. Continue README normalization after each package skeleton validates; Movement FPS and Survivors root/sample READMEs now cover install, play, controls, customization, validation, screenshots placeholders, and troubleshooting.
