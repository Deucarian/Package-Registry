...
| Bootstrap | com.deucarian.bootstrap | 1.2.8 | 2021.3 | no | clean | (none) | 2 | 1 |
...
| Package-Installer | com.deucarian.package-installer | 1.1.95 | 2021.3 | no | clean | com.deucarian.editor, com.deucarian.logging | 2 | 0 |
...
| Simultria-API | com.deucarian.simultria-api | 0.5.1 | 2021.3 | no | clean | com.deucarian.api, com.deucarian.editor, com.deucarian.session, com.deucarian.session.api-integration, com.deucarian.viewer-authentication, com.unity.nuget.newtonsoft-json | 4 | 167 |
...
| --- | --- |
| Repositories | 64 |
| Parsed methods/bodies analyzed | 15568 |
| Exact AST clone groups | 79 |
| Normalized structural clone groups | 132 |
| Same-symbol semantic candidates | 30 |
| Runtime public API symbols | 9462 |
| Editor public API symbols | 2338 |
| Test public symbols excluded from production API | 4491 |
| Sample public symbols excluded from production API | 295 |
| Internal/private production symbols | 11700 |
| Public API symbols missing XML documentation | 9712 |
| Debug invocation records | 25 |
| Unity object lifetime records | 767 |
| Documentation drift findings | 38 |
