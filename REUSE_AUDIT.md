...
| Bootstrap | com.deucarian.bootstrap | 1.2.3 | 2021.3 | no | clean | (none) | 2 | 1 |
...
| Package-Installer | com.deucarian.package-installer | 1.1.87 | 2021.3 | no | clean | com.deucarian.editor, com.deucarian.logging | 2 | 0 |
...
| Session-API-Integration | com.deucarian.session.api-integration | 1.1.0 | 2021.3 | no | clean | com.deucarian.api, com.deucarian.session, com.unity.nuget.newtonsoft-json | 3 | 57 |
...
| Viewer-Authentication | com.deucarian.viewer-authentication | 0.2.0 | 2021.3 | no | clean | com.deucarian.api, com.deucarian.command-routing, com.deucarian.editor, com.deucarian.session, com.deucarian.session.api-integration, com.unity.nuget.newtonsoft-json | 3 | 77 |
...
| --- | --- |
| Repositories | 60 |
| Parsed methods/bodies analyzed | 14493 |
| Exact AST clone groups | 73 |
| Normalized structural clone groups | 121 |
| Same-symbol semantic candidates | 29 |
| Runtime public API symbols | 8785 |
| Editor public API symbols | 2276 |
| Test public symbols excluded from production API | 3975 |
| Sample public symbols excluded from production API | 295 |
| Internal/private production symbols | 10956 |
