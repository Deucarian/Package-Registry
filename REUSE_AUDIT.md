...
This is the hardened organization-wide audit snapshot for `Deucarian` at `platform-migration-working-tree`. It uses `tree-sitter-c-sharp` for C# parsing and records the current package sources and governance state.
...
| Auto-Defense | com.deucarian.auto-defense | 0.1.0 | 6000.3 | yes | dirty | com.deucarian.gameplay-foundation, com.deucarian.encounters, com.deucarian.combat, com.deucarian.defense-games, com.deucarian.world-spawning, com.deucarian.world-navigation, com.deucarian.attacks, com.deucarian.projectiles, com.deucarian.weapon-systems | 4 | 112 |
| Auto-Defense-Suite | com.deucarian.auto-defense-suite | 0.1.0 | 6000.3 | yes | dirty | com.deucarian.gameplay-foundation, com.deucarian.persistence, com.deucarian.progression, com.deucarian.combat, com.deucarian.encounters, com.deucarian.world-spawning, com.deucarian.world-navigation, com.deucarian.defense-games, com.deucarian.attacks, com.deucarian.projectiles, com.deucarian.weapon-systems, com.deucarian.auto-defense, com.deucarian.run-upgrades, com.deucarian.idle-progression | 0 | 0 |
| Bootstrap | com.deucarian.bootstrap | 1.2.7 | 2021.3 | yes | dirty | (none) | 2 | 1 |
...
| Camera-Navigation | com.deucarian.camera-navigation | 0.2.11 | 2022.3 | yes | clean | com.deucarian.common, com.deucarian.editor | 4 | 153 |
...
| Combat | com.deucarian.combat | 0.1.0 | 6000.3 | yes | dirty | com.deucarian.gameplay-foundation | 2 | 218 |
| Command-Routing | com.deucarian.command-routing | 0.2.4 | 2021.3 | yes | clean | com.deucarian.diagnostics, com.deucarian.editor, com.deucarian.logging, com.unity.nuget.newtonsoft-json | 4 | 150 |
| Command-Routing-UDP-Integration | com.deucarian.command-routing.udp-integration | 0.1.2 | 2021.3 | yes | clean | com.deucarian.command-routing, com.deucarian.diagnostics, com.deucarian.editor, com.deucarian.logging, com.unity.nuget.newtonsoft-json | 4 | 39 |
| Command-Routing-WebGL-Integration | com.deucarian.command-routing.webgl-integration | 0.1.2 | 2021.3 | yes | clean | com.deucarian.command-routing, com.deucarian.diagnostics, com.deucarian.editor, com.deucarian.logging, com.unity.nuget.newtonsoft-json | 4 | 44 |
...
| Defense-Games | com.deucarian.defense-games | 0.1.0 | 6000.3 | yes | dirty | com.deucarian.gameplay-foundation, com.deucarian.encounters, com.deucarian.combat, com.deucarian.world-spawning, com.deucarian.world-navigation | 3 | 122 |
| Diagnostics | com.deucarian.diagnostics | 0.1.5 | 2021.3 | yes | clean | com.deucarian.editor, com.deucarian.logging, com.unity.nuget.newtonsoft-json | 4 | 63 |
| Editor | com.deucarian.editor | 1.1.0 | 2021.3 | yes | clean | (none) | 4 | 532 |
| Encounters | com.deucarian.encounters | 0.1.0 | 6000.3 | yes | dirty | com.deucarian.gameplay-foundation | 2 | 238 |
...
| Gameplay-Foundation | com.deucarian.gameplay-foundation | 0.1.0 | 2021.3 | yes | dirty | (none) | 2 | 131 |
| Idle-Progression | com.deucarian.idle-progression | 0.1.0 | 6000.3 | yes | dirty | com.deucarian.gameplay-foundation, com.deucarian.progression | 3 | 24 |
| Logging | com.deucarian.logging | 1.0.3 | 2021.3 | yes | clean | com.deucarian.editor | 5 | 69 |
...
| Monetization | com.deucarian.monetization | 0.1.0 | 6000.3 | yes | dirty | (none) | 2 | 76 |
...
| Package-Installer | com.deucarian.package-installer | 1.1.83 | 2021.3 | yes | dirty | com.deucarian.editor, com.deucarian.logging | 2 | 0 |
...
| Progression | com.deucarian.progression | 0.1.0 | 6000.3 | yes | dirty | com.deucarian.gameplay-foundation | 2 | 159 |
| Projectiles | com.deucarian.projectiles | 0.2.0 | 6000.3 | yes | dirty | com.deucarian.gameplay-foundation, com.deucarian.combat, com.deucarian.attacks, com.deucarian.world-navigation, com.deucarian.world-spawning | 2 | 120 |
...
| Simultria-API | com.deucarian.simultria-api | 1.0.0 | 2021.3 | yes | clean | com.deucarian.api, com.deucarian.editor, com.deucarian.session, com.deucarian.session.api-integration, com.deucarian.authentication, com.unity.nuget.newtonsoft-json | 5 | 167 |
| Simultria-Viewer-Connection | com.deucarian.simultria-viewer-integration | 1.0.0 | 6000.0 | yes | clean | com.deucarian.api, com.deucarian.command-routing, com.deucarian.editor, com.deucarian.logging, com.deucarian.session, com.deucarian.simultria-api, com.deucarian.authentication, com.unity.nuget.newtonsoft-json | 3 | 144 |
...
| World-Navigation | com.deucarian.world-navigation | 0.1.0 | 6000.3 | yes | dirty | com.deucarian.gameplay-foundation, com.deucarian.world-spawning | 3 | 96 |
| World-Spawning | com.deucarian.world-spawning | 0.2.0 | 6000.3 | yes | dirty | com.deucarian.common, com.deucarian.gameplay-foundation | 3 | 133 |
...
| --- | --- |
| Repositories | 63 |
| Parsed methods/bodies analyzed | 15205 |
| Exact AST clone groups | 74 |
| Normalized structural clone groups | 126 |
| Same-symbol semantic candidates | 31 |
| Runtime public API symbols | 9222 |
| Editor public API symbols | 2330 |
| Test public symbols excluded from production API | 4308 |
| Sample public symbols excluded from production API | 270 |
| Internal/private production symbols | 11557 |
| Public API symbols missing XML documentation | 9553 |
| Debug invocation records | 25 |
| Unity object lifetime records | 704 |
| Documentation drift findings | 37 |
| Dependency usage findings | 240 |
| Dependency cycles | 0 |
