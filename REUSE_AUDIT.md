...
This is the hardened organization-wide audit snapshot for `Deucarian` at `develop`. It uses `tree-sitter-c-sharp` for C# parsing and does not migrate package source.
...
| Bootstrap | com.deucarian.bootstrap | 1.0.1 | 2021.3 | yes | clean | (none) | 2 | 1 |
...
| ObjectLoading-API-Integration | com.deucarian.object-loading.api-integration | 0.2.2 | 2021.3 | yes | clean | com.unity.nuget.newtonsoft-json, com.deucarian.api, com.deucarian.object-loading | 2 | 30 |
...
| Package-Installer | com.deucarian.package-installer | 1.1.56 | 2021.3 | yes | clean | com.deucarian.editor, com.deucarian.logging | 2 | 0 |
...
| UI-FLow | com.deucarian.ui-flow | 0.3.0 | 2021.3 | yes | clean | com.unity.ugui, com.deucarian.logging | 6 | 341 |
...
| Unity object lifetime records | 58 |
